...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  192000, PLL_8, 0, 0x00 },  900000, 950000,  1 },
	[1]  = { {  384000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[2]  = { {  432000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[3]  = { {  486000, HFPLL, 2, 0x24 }, 1050000, 1050000, 4 },
	[4]  = { {  540000, HFPLL, 2, 0x28 }, 1050000, 1050000, 4 },
	[5]  = { {  594000, HFPLL, 1, 0x16 }, 1050000, 1050000, 4 },
